...
export function ConnectionError({
  ...
  return (
    <div className="rounded-md border border-[var(--border)] bg-[var(--bg-elev)] px-3 py-6 text-center">
      <div className="mx-auto inline-flex h-12 w-12 items-center justify-center rounded bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300">
