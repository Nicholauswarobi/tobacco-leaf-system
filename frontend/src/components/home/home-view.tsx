  ...
  return (
    <>
      ...
      <section className="relative grain overflow-hidden">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-3 py-6 sm:px-3 sm:py-24 lg:grid-cols-12 lg:gap-12">
          <div className="lg:col-span-7 flex flex-col justify-center">
            <div className="inline-flex w-fit items-center gap-2 rounded-sm border border-[var(--border)] bg-[var(--bg-elev)] px-3 py-1 text-xs tracking-wide text-[var(--fg-muted)]">
            ...
            <p className="mt-3 max-w-xl text-lg text-[var(--fg-muted)] leading-relaxed">
              {t("home.lead")}
            </p>
            ...
            <dl className="mt-12 grid grid-cols-3 gap-2.5 border-t border-[var(--border)] pt-3 max-w-lg">
              <div>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-md border border-[var(--border)] bg-[var(--bg-elev)] p-3 shadow-card overflow-hidden">
              ...
              <div className="aspect-[4/5] rounded overflow-hidden relative bg-gradient-to-br from-leaf-200 via-leaf-100 to-tobacco-100 dark:from-leaf-800/40 dark:via-leaf-700/30 dark:to-tobacco-800/30">
      ...
      <section className="border-y border-[var(--border)] bg-[var(--bg-elev)]">
        <div className="mx-auto max-w-7xl px-3 sm:px-3 py-5 grid gap-2.5 md:grid-cols-3">
          {FEATURES.map((f) => (
            <div key={f.title} className="flex gap-2.5">
              <div className="shrink-0 inline-flex h-11 w-11 items-center justify-center rounded bg-leaf-100 text-leaf-700 dark:bg-leaf-800/40 dark:text-leaf-300">
      ...
      {/* ─── HOW IT WORKS ─── */}
      <section className="mx-auto max-w-7xl px-3 sm:px-3 py-20">
        <div className="flex flex-col items-start sm:flex-row sm:items-end sm:justify-between gap-2.5">
          <div>
        ...
        <div className="mt-12 grid gap-2.5 md:grid-cols-3">
          {STEPS.map((s) => (
            <div
              key={s.num}
              className="group relative rounded border border-[var(--border)] bg-[var(--bg-elev)] p-3 transition-all hover:shadow-card hover:-translate-y-0.5"
            >
              ...
              <h3 className="mt-3 font-display text-2xl">{t(s.title)}</h3>
      ...
      <section className="bg-leaf-50 dark:bg-leaf-900/20 border-y border-[var(--border)]">
        <div className="mx-auto max-w-7xl px-3 sm:px-3 py-20">
          <div className="grid gap-10 lg:grid-cols-12">
            ...
            <div className="lg:col-span-8 grid gap-2 sm:grid-cols-2">
              {DETECTED.map((label, i) => (
                <div
                  key={label}
                  className="flex items-center gap-2.5 rounded border border-[var(--border)] bg-[var(--bg-elev)] px-3 py-2.5 hover:shadow-soft transition-shadow"
                >
      ...
      {/* ─── CTA ─── */}
      <section className="mx-auto max-w-7xl px-3 sm:px-3 py-24">
        <div className="relative overflow-hidden rounded-md bg-leaf-800 dark:bg-leaf-200 px-3 py-6 sm:px-16 sm:py-20 text-center">
          ...
          <p className="relative mt-2 max-w-xl mx-auto text-leaf-100 dark:text-leaf-800">
            {t("home.ctaBody")}
          </p>
