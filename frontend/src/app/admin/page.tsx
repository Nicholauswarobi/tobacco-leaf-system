...
export default function AdminPage() {
  ...
  return (
    <section className="mx-auto max-w-5xl px-5 sm:px-8 py-16">
      ...
      {!stats ? (
        <div className="max-w-md rounded-2xl border border-[var(--border)] bg-[var(--bg-elev)] p-7">
          ...
          <form onSubmit={submit} className="mt-5 space-y-4">
            <input
              ...
              className="w-full h-11 px-4 rounded-full border border-[var(--border)] bg-[var(--bg)] text-sm focus:outline-none focus:border-leaf-600 font-mono"
            />
            {error && (
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg-elev)] p-7">
